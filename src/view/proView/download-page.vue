      ...
      <div class="page_home">
        ...
        <div class="page_currency">
          ...
          <div class="currency_text">
              ...
              <div class="current_cur">1积分={{ (Number(amount)/10).toFixed(2)}}</div>
          ...
          <div class="cash_point">
             ...
             <div class="need_money ">预计所需金额：{{ amount }} {{ currency }}</div>
          </div>
          <div class="cash_point">
              <div class="page_title" style="margin-top:0;">
        ...
        <div class="btn_def btn_lg" style="margin-bottom:20px;" >
          <div>充值</div>
